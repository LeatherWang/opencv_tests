...
int main(int argc, char** argv)
{
    ...
    string file_path = "../camera_camera_calib_ak.yaml"; // camera_fisheye_ankobot
    ...
    bool bUsingSobel = parser.get<bool>("s");
...
//                continue;
    ...
    cv::fisheye::initUndistortRectifyMap(K_Mat, DistCoef, cv::Mat(), K_Mat,
