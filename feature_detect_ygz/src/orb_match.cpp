...
//        clahe->apply(srcImg2, srcImg2);
    ...
    Ptr<DescriptorExtractor> orbDetAndDsp = ORB::create();

//    Ptr<cv::BRISK> briskDetector = cv::BRISK::create(5, 1);

//    briskDetector->detect(srcImg1, keypoints_1);
//    briskDetector->detect(srcImg2, keypoints_2);
...
//    briskDetector->compute ( srcImg2, keypoints_2, descriptors_2 );
    ...
    orbDetAndDsp->detect(srcImg1, keypoints_1);
    orbDetAndDsp->detect(srcImg2, keypoints_2);
    cout<<"keypoints_1: "<<keypoints_1.size()<<"  keypoints_2: "<<keypoints_1.size()<<endl;
    orbDetAndDsp->compute ( srcImg1, keypoints_1, descriptors_1 );
    orbDetAndDsp->compute ( srcImg2, keypoints_2, descriptors_2 );
